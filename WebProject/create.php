...
<body>
    <div id="container">
        ...
        <div id="content">
        <h2>Medium Movies - <span style="color: #00b8e6">Add a Movie</span></h2>
            <?php if($errorFlag) : ?>
                <?=$_SESSION['emptyEntry'] ?>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input name="title" id="title" type="text" placeholder="The Film" class="form-control input-md"> 
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="addImage">Add a Image:</label>
  <div class="col-md-4">
