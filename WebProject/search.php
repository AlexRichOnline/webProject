<?php
    ...
    if(!isset($_SESSION['loggedOn'])){
        $_SESSION['requireLogon'] = "Sorry you must be logged into your account to access that page";
...
<body>
    <div class="container-fluid">
        ...
        <div id="content">
            <h2>Medium Movies - <span style="color: #00b8e6">Lookup Movies</span></h2>
            <?php if(isset($like)): ?>
        ...
        <form  method="post" action="search.php" class="form-horizontal">
              <!-- Select Basic -->
                <div class="form-group" id="searchMenu">
            ...
            <?php foreach($genres as $genre) : ?>
                    <option id="<?=$genre['genreName']?>" value="<?=$genre['genreName']?>"><?=$genre['genreName']?></option>
            <?php endforeach?>
