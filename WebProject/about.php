...
<body>
    ...
    <div id="container">
        ...
        <div id="content">
            <h4>Medium Movies - About</h4>
          <p>Medium Movies is a Content Management System website created by Alex Richardson</p>
          <p>
          This site allows you to view movies within the system and interact with them. 
          After you have made an account you can comment on and rate movies within the system.
